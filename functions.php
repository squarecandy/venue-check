...
function squarecandy_plugin_starter_enqueue_scripts() {
	wp_enqueue_style( 'squarecandy-plugin-starter-css', SQUARECANDY_STARTER_URL . 'dist/css/main.min.css', false, 'version-1.0.5' );
	wp_enqueue_script( 'squarecandy-plugin-starter-js', SQUARECANDY_STARTER_URL . 'dist/js/main.min.js', array( 'jquery' ), 'version-1.0.5', true );
}
